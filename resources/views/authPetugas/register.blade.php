...
<head>
  ...
  <title>Lelang | Registration</title>
...
<div class="register-box">
  <div class="register-logo">
    <a href="{{ asset('assets') }}/index2.html"><b>Petugas</b>Register</a>
  </div>
  ...
  <div class="card">
    <div class="card-body register-card-body">
      ...
      <form method="POST" action="{{ route('petugas.register.submit') }}">
      @csrf
        ...
        <div class="input-group mb-3">
          <input id="no_telp" type="text" class="form-control" name="no_telp" required autofocus autocomplete="no_telp" placeholder="Phone number">
          <div class="input-group-append">
            <div class="input-group-text">
